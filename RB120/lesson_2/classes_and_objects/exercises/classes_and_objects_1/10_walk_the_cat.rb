...
Using the code from the previous exercise, create a module named Walkable that 
contains a method named #walk. This method should print Let's go for a walk! 
...
In our solution, we create a module named Walkable that contains a method named 
#walk. We give Cat access to this method by including Walkable in the class, 
like this:
