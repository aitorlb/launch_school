...
@name. In this exercise, we use an instance variable to assign a unique name to 
the kitty object.

To accept arguments upon initialization, we need to add a parameter to 
#initialize. In our solution, we accept one argument, name, and assign it to an 
instance variable named @name. The instance variable is now available to 
