...
To modify a value using a setter method, we need to add additional syntax. When 
invoking setter methods, they must be denoted with self. We're required to use 
self so that Ruby knows the difference between initializing a local variable 
and invoking a setter method.
