...
however, most notably, class methods are only associated with the class itself, 
not any instance of the class. Within class methods, we're restricted from 
adding data specific to objects of the class, like adding a name to an instance 
of Cat. Think of class methods as generic actions a class may perform, like 
this:
