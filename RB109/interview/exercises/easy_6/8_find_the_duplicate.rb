...
- rules:
  - Only one element is dupliated in the Array

Test cases
- Well covered by examples

Describe Agorithm
- group array by elements into Hash
- find element whose value size is greater than one
- return first element of found value
...
puts find_dup(array) == 1 # => true

array = [18,  9, 36, 96, 31, 19, 54, 75, 42, 15,
38, 25, 97, 92, 46, 69, 91, 59, 53, 27,
14, 61, 90, 81,  8, 63, 95, 99, 30, 65,
78, 76, 48, 16, 93, 77, 52, 49, 37, 29,
89, 10, 84,  1, 47, 68, 12, 33, 86, 60,
